...
public class PinpointTurretTest extends GorillabotCentral {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(!isStopRequested()){
            ...
            double TurretHeading = (Turret.turret.getCurrentPosition() / ticksPerDegree);
            //should set up straight facing forward -- test
            //degree the turret rotated -- in degrees
            ...
            dashboardTelemetry.addData("Current heading", FinalHeading);
