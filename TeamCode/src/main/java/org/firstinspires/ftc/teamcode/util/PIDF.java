...
public class PIDF {
    ...
    public void setCoefficients(double new_p, double new_i, double new_d, double kV) {
        this.kP = new_p;
        this.kI = new_i;
        this.kD = new_d;
        this.kV = kV;
...
// Scale feedforward based on voltage difference
        ...
        out = (feedforward + (this.kP * error) + (this.kI * integral_sum) + (this.kD * derivative));
