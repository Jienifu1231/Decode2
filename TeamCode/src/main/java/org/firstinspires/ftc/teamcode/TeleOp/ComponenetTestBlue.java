...
@TeleOp
@Config
public class ComponenetTestBlue extends GorillabotCentral {
    public PID lime_pid;
   /* public static double kp = 0.031;//0.06
    public static double ki = 0.15;
    public static double kd = 0.085;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(!isStopRequested()){
            ...
            */
            if(g2.dpadUp.wasJustPressed()){
                AngleOffset += 0.01;
            }else if(g2.dpadDown.wasJustPressed()){
                AngleOffset -= 0.01;
            }
            ...
            telemetry.addData("turret target angle", Turret.TurretAngle);
            ...
            telemetry.addData("Lift pos", Lift.lift1.getPosition());
            telemetry.update();
